...
def checkChanges(xpath, driver: uc.Chrome, text):
    WebDriverWait(driver, 10).until(EC.presence_of_element_located((By.XPATH, xpath)))
    field = driver.find_element(By.XPATH, xpath).text
    print(field)
    if text == field:
        return True
    return False
...
def input_deal(driver: uc.Chrome):
    ...
    inputField(xpath='//*[@id="page-iCRM Deal"]/div[2]/div[2]/div/div[3]/div[2]/div[1]/div[2]/div/div/div[3]/div[3]/div/div[1]/form/div[1]/div/div[2]/div[1]',
...
def check_changes(driver: uc.Chrome):
    ...
    passed = checkChanges(
        xpath='//*[@id="page-iCRM Deal"]/div[2]/div[2]/div/div[3]/div[2]/div[1]/div[2]/div/div/div[3]/div[3]/div/div[1]/form/div[1]/div/div[2]/div[1]',
        driver=driver, text="test")
    if not passed:
        return False
    checkChanges(
        '//*[@id="page-iCRM Deal"]/div[2]/div[2]/div/div[3]/div[2]/div[1]/div[2]/div/div/div[3]/div[3]/div/div[1]/form/div[2]/div/div[2]/div[1]',
        driver, text="12-05-2023\n")
    if not passed:
        return False
    checkChanges(text='13-05-2023\n',
               xpath='//*[@id="page-iCRM Deal"]/div[2]/div[2]/div/div[3]/div[2]/div[1]/div[2]/div/div/div[3]/div[4]/div/div[2]/form/div/div/div[2]/div[1]',
               driver=driver)
    if not passed:
        return False
    return True
